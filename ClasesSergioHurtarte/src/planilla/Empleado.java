...
public class Empleado {
	...
	public Empleado(String codigoEmpleado, String nombre, String apellido, String carnetIgss, double sueldoBase,
			double bonificacion) {
	...
	public String getDatos() {
		...
		return "Los datos del empleado son   Codigo: " + getCodigoEmpleado() + " " + getNombre() + " " + getApellido()
				+ " " + getCarnetIgss();
	}
